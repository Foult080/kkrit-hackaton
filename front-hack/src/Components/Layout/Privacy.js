  ...
  return (
    <Container style={{ marginTop: "6rem",marginBottom: "2rem" }}>
      ...
      <p>
        ...
        безопасности персональных данных, предпринимаемые КГБПОУ "Красноярский
      ...
      <p>
        ...
        сети интернет по сетевому адресу https://www.kkrit-hackaton.ru.
      </p>
      <p>
      ...
      <p>
        5.3. Также на сайте происходит сбор и обработка обезличенных данных о
      ...
      <p>
        5.6. Обработка персональных данных, разрешенных для распространения, из
      ...
      <p>
        ...
        содержащимся на веб-сайте https://kkrit-hackaton.
      </p>
      <p>
        ...
        почты upr@kraskrit.ru с пометкой «Отказ от уведомлений о новых продуктах
      ...
      <p>
        ...
        являются: – уставные (учредительные) документы Оператора; – договоры,
      ...
      <p>
        ...
        специальные формы, расположенные на сайте https://www.kkrit-hackaton.ru
      ...
      <p>
        ...
        уведомление на адрес электронной почты Оператора upr@kraskrit.ru с
      ...
      <p>
        ...
        электронный адрес Оператора upr@kraskrit.ru с пометкой «Отзыв согласия
      ...
      <p>
        ...
        Оператору с помощью электронной почты upr@kraskrit.ru.
      </p>
      <p>
      ...
      <p>
        ...
        Интернет по адресу https://www.kkrit-hackaton.ru/privacy.
      </p>
    </Container>
  );
}
